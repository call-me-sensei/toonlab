...
captures reusable landform craft from the 0.4.7 karst qualification run without
depending on that scene's project helpers, asset ids, or frozen catalog count.
