...
Module: `toonlab/rock-shader` — 13 groups, 70 fields.
...
| `skyFillTint` | color | `[1, 1, 1]` (#ffffff) | — | Yes | Rock-specific RGB weighting for indirect sky light and blue back-shadow separation. |
...
Module: `toonlab/ground-shader` — 10 groups, 67 fields.
