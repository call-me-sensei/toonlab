...
const ENABLE_JUMP_ANIMATION = ENABLE_WALKING_ANIMATION && URL_PARAMS.get('jumpAnim') !== 'none';
const ENABLE_RUNNING_ANIMATION = ENABLE_WALKING_ANIMATION && URL_PARAMS.get('runAnim') !== 'none';
const ENABLE_SWIM_ANIMATION = ENABLE_WALKING_ANIMATION && URL_PARAMS.get('swimAnim') !== 'none';
...
const IDLE_BODY_MODE = URL_PARAMS.get('idleBody') || 'full';
...
function createInitialWaterSettings() {
  ...
  return createWaterSettings({
    ...
    quality: URL_PARAMS.get('waterQuality') || undefined,
