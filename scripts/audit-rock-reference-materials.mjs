...
const output = resolve(
  process.env.TOONLAB_ROCK_MATERIAL_AUDIT_OUTPUT
    || resolve(ROOT_DIR, 'assets-local', 'rock-references', 'material-audit.json'),
);
...
const result = spawnSync(editor, [
  ...
  env: {
    ...process.env,
    TOONLAB_ROCK_MATERIAL_AUDIT_OUTPUT: output,
  },
  stdio: 'inherit',
});
