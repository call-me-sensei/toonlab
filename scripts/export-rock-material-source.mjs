...
const output = resolve(
  process.env.TOONLAB_ROCK_MATERIAL_SOURCE_OUTPUT
    || resolve(ROOT_DIR, 'assets-local', 'rock-references'),
);
...
const result = spawnSync(editor, [
  ...
  env: {
    ...process.env,
    TOONLAB_ROCK_MATERIAL_AUDIT_OUTPUT: resolve(output, 'material-audit.json'),
    TOONLAB_ROCK_MATERIAL_SOURCE_OUTPUT: output,
  },
  stdio: 'inherit',
});
