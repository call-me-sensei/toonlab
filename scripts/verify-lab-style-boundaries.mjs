...
assert.equal(flowerStore.actions.getRecipeDocument().options.vegetationShader, undefined);
...
assert.equal(STYLE_BUNDLE_SLOTS.flowers.label, 'Flower fields');
assert.equal(STYLE_BUNDLE_SLOTS.flowers.selectionKind, 'style');
assert.equal(STYLE_BUNDLE_SLOTS.vegetationShader.selectionKind, 'style');
