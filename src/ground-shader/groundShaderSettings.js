...
const GROUP_DEFINITIONS = Object.freeze({
  layers: Object.freeze({
    ...
    fields: Object.freeze({
      grassTint: field({ defaultValue: [0.42000002, 0.60000002, 0.43338463], description: 'Tint for meadow, lawn, and groundcover-painted terrain. The default is the accepted P18 landscape Grass Tint.', label: 'Grass Tint', type: 'color' }),
      dirtTint: field({ defaultValue: [0.500646, 0.529309, 0.552083], description: 'Tint for exposed soil, trails, and earth. The default is the accepted P18 landscape Dirt Tint.', label: 'Dirt Tint', type: 'color' }),
      rockTint: field({ defaultValue: [0.893158, 0.921875, 0.829687], description: 'Tint for steep ground, cliff, and embedded-stone layers. The default is the accepted P18 landscape Rock Tint.', label: 'Rock Tint', type: 'color' }),
      sandTint: field({ defaultValue: [0.83077, 0.810712, 0.623078], description: 'Tint for beaches, dry sediment, and shoreline-painted terrain. The default is the accepted P18 landscape Sand Tint.', label: 'Sand Tint', type: 'color' }),
...
registerGroundShaderPreset('call_me_sensei', {
  description: 'Call Me Sensei ground treatment initialized from the accepted P18 landscape layer, projection, cliff, wetness, snow, and distance inputs.',
  label: 'Call Me Sensei',
  settings: {
    layers: {
      brightness: 0,
      contrast: 1,
      dirtTint: [0.500646, 0.529309, 0.552083],
      grassTint: [0.42000002, 0.60000002, 0.43338463],
      rockTint: [0.893158, 0.921875, 0.829687],
      sandTint: [0.83077, 0.810712, 0.623078],
      saturation: 1,
      textureStrength: 1,
    },
    lighting: {
      ...
      shadowTintStrength: 0.38,
      skyFillStrength: 0.14,
    },
    macro: {
      amount: 0.1,
      scale: 1 / 84.172,
      secondaryAmount: 0,
      tint: [0.42000002, 0.60000002, 0.43338463],
      tintStrength: 0,
    },
    material: {
...
export const GROUND_SHADER = Object.freeze({
  ...
  description: 'Reusable terrain and ground material treatment, independent from landscape geometry.',
