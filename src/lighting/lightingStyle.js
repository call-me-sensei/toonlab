...
registerLightingStylePreset('call-me-sensei', {
  ...
  settings: {
    ...
    ambientLight: { color: [0.62, 0.72, 1.0], intensity: 0.58 },
    exposure: { base: 1.08 },
    fixtures: { intensityScale: 1.3 },
    toonResponse: { bandSoftness: 0.06, rimInfluence: 0.35, shadowTint: [0.42, 0.5, 0.85] },
    dayCycle: [
      { accentScale: 0.3, ambientScale: 0.62, exposureScale: 0.94, fixtureScale: 1.55, fogColor: [0.16, 0.2, 0.46], hour: 0, sky: { horizon: [0.12, 0.2, 0.5], stars: 1, zenith: [0.02, 0.05, 0.2] }, skyGroundTint: [0.72, 0.78, 1.05], skyTopTint: [0.42, 0.55, 1.05], sunColor: { kelvin: 11500 }, sunIntensity: 0.16 },
      { accentScale: 1.2, ambientScale: 0.85, exposureScale: 1.04, fixtureScale: 0.7, fogColor: [1.0, 0.68, 0.5], hour: 6, sky: { horizon: [1.0, 0.72, 0.52], stars: 0, zenith: [0.38, 0.5, 0.95] }, skyGroundTint: [1.2, 0.95, 0.78], skyTopTint: [0.95, 0.85, 1.05], sunColor: { kelvin: 2900 }, sunIntensity: 0.65 },
      { accentScale: 1.15, ambientScale: 1.1, exposureScale: 1.1, fixtureScale: 0, fogColor: [0.72, 0.86, 1.0], hour: 12, sky: { horizon: [0.72, 0.9, 1.05], stars: 0, zenith: [0.18, 0.5, 1.0] }, skyGroundTint: [1.12, 1.02, 0.9], skyTopTint: [0.78, 0.98, 1.2], sunColor: { kelvin: 5400 }, sunIntensity: 1.25 },
      { accentScale: 1.35, ambientScale: 0.85, exposureScale: 1.05, fixtureScale: 0.85, fogColor: [1.0, 0.52, 0.36], hour: 18, sky: { horizon: [1.1, 0.5, 0.32], stars: 0.08, zenith: [0.3, 0.3, 0.78] }, skyGroundTint: [1.25, 0.85, 0.66], skyTopTint: [0.95, 0.72, 1.0], sunColor: { kelvin: 2100 }, sunIntensity: 0.72 },
      { accentScale: 0.4, ambientScale: 0.64, exposureScale: 0.96, fixtureScale: 1.5, fogColor: [0.18, 0.22, 0.5], hour: 21, sky: { horizon: [0.15, 0.22, 0.52], stars: 0.95, zenith: [0.03, 0.07, 0.24] }, skyGroundTint: [0.74, 0.8, 1.05], skyTopTint: [0.45, 0.58, 1.05], sunColor: { kelvin: 11000 }, sunIntensity: 0.18 },
    ],
  },
});
