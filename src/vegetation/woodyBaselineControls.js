// Neutral capability contract for the licensed woody baseline.
//
// This module deliberately contains no source-package object names, socket
// identifiers, UI labels, or preset names. The private adapter beside the
// licensed local library maps these stable Toonlab paths to the exact graph.
// Keeping the public registry separate lets us prove that every meaningful
// source input is accounted for without making source conventions part of
// treeRecipe or the public API.
...
// profile. The licensed file is only a graph carrier after this step: none of
// its saved preset values can silently define a Toonlab species.
