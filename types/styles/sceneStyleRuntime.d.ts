 ...
 */
export function createSceneStyleRuntime({ collision, collisionAdapter, collisionAdapters, collisionHeightAt, environmentRoot, fog, post, quality, renderer, rendererConfiguration, scene, sky, timeOfDay, water, world, }?: {
    collision?: string;
    collisionAdapter?: Readonly<{
        id: string;
        kinds: readonly string[];
        register: any;
    }>;
    collisionAdapters?: any[];
    collisionHeightAt?: any;
    environmentRoot?: any;
    fog?: any;
    post?: any;
    quality?: string;
